...
export const Element9 = (): JSX.Element => {
  return (
<footer className="relative w-full max-w-[1440px] h-[346px] top-[120px] bg-[#171C29] overflow-hidden font-['Raleway',Helvetica] mx-auto">
