...
export const SectionComponentNodeProizvodstvoshatrov  = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col items-center gap-[45px] relative w-full max-w-[1342px] mx-auto py-12">
      <h2 className="font-semibold text-4xl text-center leading-normal whitespace-nowrap [font-family:'Raleway',Helvetica] tracking-[0]">
