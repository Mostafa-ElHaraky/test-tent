...
<br></br>
            ...
            <div className="inline-flex flex-col items-center gap-3 relative flex-[0_0_auto]">
              ...
              <Button className="relative w-[412px] h-[68px] rounded-2xl border-[none] shadow-2 [background:linear-gradient(180deg,rgba(115,168,255,1)_0%,rgba(111,167,255,1)_37%,rgba(60,108,236,1)_100%)] hover:opacity-90">
