  ...
  return (
    <section className="w-full py-16 relative">
      <div className="flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col gap-[60px]">
          <div className="flex flex-col gap-10">
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-3">
                <div className="font-medium text-[#4f5d80] text-lg leading-6 [font-family:'Raleway',Helvetica]">
            ...
            <div className="w-[496px] font-semibold text-[#394355] text-base leading-6 [font-family:'Raleway',Helvetica]">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              <h3 className="font-bold text-[#394355] text-base leading-6 [font-family:'Raleway',Helvetica]">
                Задача
              </h3>
              <p className="w-[418px] font-normal text-[#394355] text-sm leading-5 [font-family:'Raleway',Helvetica]">
              ...
              <div className="flex flex-col gap-4">
                {accomplishments.map((text, index) => (
                  <div key={index} className="flex items-start gap-6">
                    ...
                    <div className="flex flex-col gap-3">
                      <p className="w-[358px] font-normal text-[#394355] text-sm leading-5 [font-family:'Raleway',Helvetica]">
                        {text}
                      </p>
                    </div>
                  </div>
          ...
          <div className="flex items-center gap-[33px] mt-12">
            <Button
              variant="outline"
              className="flex items-center gap-[15px] px-6 py-3 bg-white rounded-[50px] border-[3px] border-solid shadow-[var(--)] backdrop-blur-[79px]"
            >
              <div className="relative w-[50px] h-[50px]">
                <div className="relative w-[35px] h-[35px] top-2 left-2 bg-[url(/GROP-9.png)] bg-[100%_100%]" />
              </div>
              <span className="font-bold text-[#232c42] text-base [font-family:'Raleway',Helvetica]">
                Смотреть отзыв
              </span>
            </Button>
            ...
            <div className="flex items-center gap-[18px]">
              <img
                ...
                src="/Image-18.png"
              />
              <div className="w-[150px] font-semibold text-[#394355] text-base leading-5 [font-family:'Raleway',Helvetica]">
          ...
          <div className="flex flex-col gap-3 mt-6">
            <p className="w-[412px] font-normal text-[#394355] text-xs text-center [font-family:'Raleway',Helvetica]">
        ...
        {/* Right column with cards and image */}
        <div className="flex flex-col">
            ...
            {serviceCards.map((card, index) => (
              ...
              >
                <CardContent className="flex flex-col items-center justify-center h-[85px] gap-1.5 p-5">
                  <div className="font-semibold text-[#394355] text-base text-center leading-5 [font-family:'Raleway',Helvetica]">
                    {card.title}
                  </div>
                  <div className="font-normal text-[#394355] text-base text-center leading-5 [font-family:'Raleway',Helvetica]">
                    {card.content}
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="relative w-full h-[709px]">
            <div className="relative w-[808px] h-[785px] -top-3.5 left-[-38px] bg-[url(/Fc3740fa54440e5eaefe94690ddc2643-4.png)] bg-cover bg-[50%_50%]">
              {/* Navigation buttons */}
              <Button
                variant="outline"
                size="icon"
              ...
              <Button className="h-[60px] absolute top-[633px] left-[548px] inline-flex items-center gap-2.5 pl-6 pr-3 py-3 bg-[#232c42] rounded-[50px] border-[3px] border-solid border-[#527dc5] shadow-[var(--)] backdrop-blur-[79px]">
                <span className="font-bold text-white text-base [font-family:'Raleway',Helvetica]">
                  Показать еще
                </span>
                <img alt="Arrow icon" src="/FRAME-4.svg" />
              </Button>
