...
export const Services4 = (): JSX.Element => {
  ...
  return (
    <main className="w-full h-[765px] flex justify-center  bg-white">
      <div className="w-full max-w-[1440px] h-full ">
        {/* Your existing section wrapped in the main container */}
        <section className="relative w-full h-[726px] top-[200px] rounded-[30px] overflow-hidden shadow-[var(--)] backdrop-blur-[79px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(79px)_brightness(100%)]">
