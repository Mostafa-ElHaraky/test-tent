...
export const DlyaVremennyh1 = (): JSX.Element => {
  const navigate = useNavigate();
...
const guaranteeItems = [
  ...
  return (
    <main className="relative w-full max-w-[1440px] h-[923px] bg-white mx-auto">
        ...
        <div className="absolute w-full h-[1081px] top-0 left-0 rounded-[0px_0px_30px_30px] overflow-hidden">
          <div className="relative w-[1734px] h-[1275px] top-[-194px]">
            ...
            <div className="absolute w-[1440px] h-[689px] top-[586px] left-0 rounded-[0px_0px_20px_20px] overflow-hidden">
              <div className="relative bottom-[200px] h-[689px] bg-[url(/angar.png)] bg-[100%_100%]">
              </div>
            </div>
            ...
            <div className="inline-flex flex-col items-start gap-6 relative flex-[0_0_auto]">
              <div className="inline-flex flex-col items-start gap-5 relative flex-[0_0_auto]">
                <div className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
                  ...
                  <h1 className="w-[966px] font-medium text-[40px] leading-[normal] relative [font-family:'Raleway',Helvetica] tracking-[0]">
                  <span className="text-[#335dc2] mr-2">ТЕНТОВЫЕ АНГАРЫ В МОСКВЕ В МОСКВЕ</span>
...
<br></br>
        ...
        {/* Guarantees card */}
        <Card className="absolute w-[585px] h-[124px] top-[525px] left-[5px] bg-[#fffffff2] rounded-[20px] overflow-hidden border-[3px] border-solid border-white shadow-[0px_24px_38px_#161d2414] backdrop-blur-[79px]">
