...
const footerSections = [
  {
    title: "Клиентам",
    links: ["Отзывы", "Готовые решения", "Вопросы и ответы", "Контакты"],
  },
  {
    title: "Каталог",
    links: ["Шатры", "Тентовые ангары", "Оснащение"],
  },
  {
    title: "О компании",
    links: ["Компания", "Команда", "Производство", "Проектирование"],
  },
];

export const Footer1 = (): JSX.Element => {
  return (
    <footer className="relative w-full max-w-[1440px] h-[346px] bg-[#161c29] overflow-hidden font-['Raleway',Helvetica]">
      ...
      <div className="flex flex-col w-[157px] h-[55px] items-start gap-3 absolute top-[42px] left-12">
        <img
          ...
          alt="Mobile tent ru"
          src="/footer1-mobile-tent-ru.png"
        />
      ...
      <div className="absolute w-[187px] h-[161px] top-[42px] left-[960px]">
        ...
        {/* CTA Button */}
        <Button className="absolute w-[187px] h-[53px] top-[108px] left-0 rounded-2xl border-[none] shadow-[0px_15px_20px_#1f7cfe24] [background:linear-gradient(180deg,rgba(115,168,255,1)_0%,rgba(111,167,255,1)_37%,rgba(60,108,236,1)_100%)]">
          <span className="absolute w-[167px] top-2 left-2.5 font-semibold text-white text-sm text-center tracking-[0] leading-normal">
