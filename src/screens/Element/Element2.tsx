...
const processSteps = [
  {
    ...
    description:
      "Эксперты помогут определиться\nс выбором модели и оснащения под ваши задачи. Проведут расчет стоимости, сроков изготовления и доставки",
    images: [
      {
        src: "/checklist-------1.png",
        className: "absolute w-[171px] h-[175px] top-[81px] left-[289px]",
      },
      {
        src: "/felt-tip-pen--10-------1.png",
        className:
          "absolute w-[105px] h-[105px] top-[161px] left-[365px] object-cover",
      },
    ],
  },
  {
    ...
    description: (
      <>
        ...
        <span className="italic text-[#527dc5]">*Отправляем КП со сметой</span>
      </>
    ),
    images: [
      {
        src: "/tent-i03-1.png",
        className: "absolute w-[88px] h-[185px] top-[63px] left-[228px]",
      },
    ],
  },
];

export const Element2 = (): JSX.Element => {
  return (
    <main className="relative w-full max-w-[1440px] h-[1730px] bg-white mx-auto">
      <section className="relative h-[1730px] rounded-[0px_0px_30px_30px]">
        {/* Background image */}
        <img
          className="w-[661px] h-[851px] absolute left-[766px] top-0 blur-[35px] object-cover"
          alt="Blue water splashing"
          src="/blue-water-splashing-alone--9-------1-3.png"
        />
  ...
  >
    <CardContent className="p-0 h-full">
      <div className="relative w-full h-full pl-28"> {/* Added padding for text area */}
        ...
        {/* Guarantees card */}
        <Card className="absolute w-[660px] h-[164px] top-[425px] left-[35px] bg-[#fffffff2] rounded-[20px] overflow-hidden border-[3px] border-solid border-white shadow-[0px_24px_38px_#161d2414] backdrop-blur-[79px]">
          <CardContent className="p-0">
            <div className="inline-flex flex-col items-start gap-4 relative top-[29px] left-[25px]">
              <div className="relative w-fit mt-[-1.00px] font-bold text-transparent text-xl leading-[normal] whitespace-nowrap [font-family:'Raleway',Helvetica] tracking-[0]">
        ...
        {/* Promotions section */}
        <div className="inline-flex flex-col items-center gap-9 absolute top-[674px] left-[35px]">
      ...
      {/* Services section */}
      <section className="inline-flex flex-col items-start gap-20 absolute top-[1245px] left-12">
        <div className="inline-flex flex-col items-start gap-6 relative flex-[0_0_auto]">
          <h2 className="relative w-[546px] mt-[-1.00px] font-normal text-transparent text-4xl leading-[normal] [font-family:'Raleway',Helvetica] tracking-[0]">
            <span className="font-semibold text-[#232c42]">
              У нас вы можете получить
            </span>
            <span className="font-medium text-[#232c42]"> </span>
      ...
      {/* Process steps */}
      <section className="inline-flex items-start gap-5 absolute top-[1216px] left-[732px]">
        {processSteps.map((step, index) => (
          <Card
            key={index}
            className="relative w-[433px] h-[434px] rounded-[20px] overflow-hidden shadow-[0px_24px_38px_#161d2414] backdrop-blur-[79px]"
          >
            <CardContent className="p-0">
